...
```{r slopemodels}
slopes_vp.f<-rma.mv(yi = b ~ capped_sd * p, V = real_ses, random = ~1|order/g/s/study, data = slopes,test="t")
...
slopes_vp.s<-rma.mv(yi = b ~ capped_sd * p, V = real_ses, random = ~1|order/g/study, data = slopes,test="t")
