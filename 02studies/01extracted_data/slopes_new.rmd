...
plot(1:139,results$invvar_e, main = "influnece of data points on e",ylab="inverse variance [log]",log="y")
...
#26 inverse variances reset to median*10
...
lank <- data.frame(
  ...
  bse = c(11.61, 7.04, 19.64, 7.25, 13.84, 14.22, 12.81),
  c = rep(0,7),cse = rep(NA,7),d=rep(1,7),dse = rep(NA,7),
  e = c(19.22, 19.38, 18.63, 19.46, 18.78, 18.32, 17.70),
  ese = c(0.46,0.72,1.13, 1.00, 0.42, 0.75, 0.34))
 lank$invvar_b<-1/(lank$bse^2)
lank$invvar_e<-1/(lank$ese^2)
