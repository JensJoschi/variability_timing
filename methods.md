...
CDL ~ latitude + 1|(study nested in species)
...
A The effect size reported shuold be slope (measured in h/°N) +CI and Fisher's Z transform of pearson's r.  
...
[x] weights = 1/s.e. of slope estimate
