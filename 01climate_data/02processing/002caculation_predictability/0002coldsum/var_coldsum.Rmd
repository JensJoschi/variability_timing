...
getting N(days) for all stations and years
...
for (i in 1:nrow(final_10_50[[1]])){
  ...
  #formula variance for weighed sample, using frequency weighed unbiased estimateor
...
plot(to_plot[,2]~to_plot[,3],bg=rgb(0,to_plot$sd,0,maxColorValue=50),col=NA,main="Winter variability",pch=22,cex=0.8)
points(x=(-170):(-121),y= rep(25,50), col = rgb (0, 0:50,0,maxColorValue = 50),pch=22,cex=0.6)
text(-170,22,"sd=0")
text(-120,22,"sd = 50")
```
```{r plot_the_results}
final_10_50[[1]]<-final_10_50[[1]][,1:147]
final_10_50[[1]]$means<-weighted_means(final_10_50[[1]],final_10_50[[2]])
final_10_50[[1]]$sd<-standard_dev(final_10_50[[1]])
...
plot_results(final_10_50[[1]],"10 days below 5°C")
input<-final_10_50[[1]]
to_plot<-input[is.na(input$sd)==FALSE,]
to_plot[to_plot$sd>50,"sd"]<-50
plot(to_plot[,2]~to_plot[,3],bg=rgb(0,to_plot$sd,0,maxColorValue=50),col=NA,main="Winter variability",pch=22,cex=0.8)

plot(final_10_50[[1]]$mean~final_10_50[[1]]$sd,pch=22,cex=0.5)
