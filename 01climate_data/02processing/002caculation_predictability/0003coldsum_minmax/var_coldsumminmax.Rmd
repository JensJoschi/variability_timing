...
reslist<-data.frame(unique(station$ID),mean_winter,sd_winter,cor_7,cor_14,cor_21,nyears[i])
names(reslist)<-c("ID","meanwinter","sd winter", "cor 1wk","cor2wk","cor3wk","nyears")
write.table(reslist,"results.txt",append=TRUE,quote=FALSE,row.names=FALSE,col.names=TRUE)
}
```
